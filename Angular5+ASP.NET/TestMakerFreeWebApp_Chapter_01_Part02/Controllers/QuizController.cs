...
using TestMakerFreeWebApp_Chapter_01_Part02.ViewModels;

namespace TestMakerFreeWebApp_Chapter_01_Part02.Controllers
{
    ...
    public class QuizController : Controller
    {
        ...
        public IActionResult ByTitle(int num = 10)
        {
            ...
            return new JsonResult(sampleQuizzes.OrderBy(p => p.Title),
                 new JsonSerializerSettings()
                 {
                     Formatting = Formatting.Indented
                 });
